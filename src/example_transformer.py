...
def main():
    ...
    # Build model graph
    encoder_input = tf.placeholder(tf.int64, shape=(None, None))   # [batch_size, timestep] ids to look up word embeddings
    ...
    encoder_output = encoder(inputs=src_input_embedding,
                             sequence_length=encoder_input_length)  # [batch_size, timestep, enc_dim]
